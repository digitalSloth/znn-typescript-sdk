...
description: Install the ZNN TypeScript SDK and connect to the Zenon Network of Momentum.
---
...
:::note
Node.js environments don't need this configuration – PoW files are loaded automatically from the installation directory.
:::
...
:::tip
Combine `prepareBlock` with `Zenon.setPowProvider` (a Web Worker provider) to keep the connection alive *during* PoW as well as control publishing afterward.
:::

## Next Steps

- **[API Overview](./api-overview.md)** – All API methods and embedded contract calls
